...
export default function Footer({
  logoText = 'QuickLand',
  companyDescription = 'The fastest way to create stunning landing pages. Build, customize, and deploy professional websites in minutes with our intuitive drag-and-drop builder.',
  contactEmail = 'hello@quickland.com',
  contactPhone = '+1 (555) 123-4567',
  contactAddress = '123 Innovation Drive, San Francisco, CA 94105',
  newsletterTitle = 'Stay in the Loop',
  newsletterDisclaimer = 'Get the latest templates, features, and design tips. No spam, unsubscribe anytime.',
